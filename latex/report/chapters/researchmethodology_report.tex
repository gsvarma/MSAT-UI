...
Task success determines whether the user can perform the given task based on success criteria respective to each task. The user provides the perceived usability rating in comparison on the scale of 0 to 10, 0 being low and ten be higher with Uni Polar Likert Scale of attribute high usable on one end and not at all usable on other end. It determines how usable is a design in comparison to alternate design. 
