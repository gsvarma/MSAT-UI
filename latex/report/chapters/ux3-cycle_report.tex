...
\begin{myboxi}{{\textbf{Do users prefer bug icons or list view for bugs in same file?}}}
...
\begin{myboxi}{{\textbf{Does MSAT UI with five different mechanisms helps in fixing the bugs in a faster way in comparison to using multiple tools with native user interfaces?}}}
...
\begin{myboxi}{{\textbf{Do users prefer having multiple windows to single window in tracing previous bug fixes in a method?}}}
	\\ \\ Users preferred single window as it is easy to perceive results. \\
\end{myboxi}
\clearpage
\begin{myboxi}{{\textbf{Do users be able to keep up in state of workflow as tools scale?}}}
	\\ \\ Yes! with the help of table view as it assists in having a glance in single view. \\
\end{myboxi}

\begin{myboxi}{{\textbf{While tracing previous bug fixes in a method, do users prefer a table view to a before/after windows?}}}
