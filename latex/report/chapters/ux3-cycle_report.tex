\chapter{User Experience Design Cycle 3}
...
The ‘bug icon’ idea is about having a bug icon in the gutter, and user clicks to see the bug description at a particular line. This idea could be well understood, looking at following figure \ref{fig:S31_next} or a complete prototype images added in appendix.
...
The ‘list’ idea is about having a complete list of bugs in a file, and the user sees the list once he opens a file, then the bugs present in the file are shown in list. This idea could be well understood, looking at following figure \ref{fig:S31_list} or a complete prototype images added in appendix.
